...
#ifndef SynchrotronRadiation_h
#define SynchrotronRadiation_h 1
...
class SynchrotronRadiation : public G4VDiscreteProcess
{
 public:
  explicit SynchrotronRadiation(const G4String& pName = "SynRad",
                                G4ProcessType type    = fElectromagnetic,
				const G4double pMeanFreePathFactor = 1.0);

  virtual ~SynchrotronRadiation();

  SynchrotronRadiation& operator=(const SynchrotronRadiation& right) =
    delete;
  SynchrotronRadiation(const SynchrotronRadiation&) = delete;
...
inline G4double SynchrotronRadiation::Chebyshev(G4double a, G4double b,
...
#endif  // end of SynchrotronRadiation.hh
