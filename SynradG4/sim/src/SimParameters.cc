...
void SimParameters::SetMagParameters(G4String magName, G4String magType, G4double magLength, 
...
void SimParameters::CleanMagParameters()
{
	_magName.clear();
	_magType.clear();
	_magLength.clear();
...
void SimParameters::SetAbsParameters(G4double absSizeX, G4double absSizeY, G4double absSizeZ,
...
void SimParameters::CleanAbsParameters()  
{
	_absSizeX.clear();
	_absSizeY.clear();
	_absSizeZ.clear();
...
void SimParameters::PrintTrkGeoCut()
{
	G4cout<<"\n\n=================================================================="<<G4endl;
...
void SimParameters::PrintGeoParameters()
{
	G4cout<<"\n\n=================================================================="<<G4endl;
...
void SimParameters::PrintStoreTrajectories()
{
	G4cout<<"\n\n=================================================================="<<G4endl;
...
void SimParameters::PrintGenerator()
{
	G4cout<<"\n\n=================================================================="<<G4endl;
...
void SimParameters::PrintBeamParameters()
{
	G4cout<<"\n\n=================================================================="<<G4endl;
...
void SimParameters::PrintSolParameters()
{
	G4cout<<"\n\n=================================================================="<<G4endl;
...
void SimParameters::PrintMagParameters()
{
	G4cout<<"\n\n=================================================================="<<G4endl;
...
void SimParameters::PrintAbsParameters()
{
	G4cout<<"\n\n=================================================================="<<G4endl;
...
void SimParameters::PrintGammaCut()
{
	G4cout<<"\n\n=================================================================="<<G4endl;
...
void SimParameters::PrintMeanFreePathFactor()
{
	G4cout<<"\n\n=================================================================="<<G4endl;
...
void SimParameters::PrintBeampipeFileName()
{
	G4cout<<"\n\n=================================================================="<<G4endl;
...
void SimParameters::PrintIpBeampipeParameters()
{
	G4cout<<"\n\n=================================================================="<<G4endl;
