...
///////////////////////////////////////////////////////////////////////
//  Constructor
SynchrotronRadiation::SynchrotronRadiation(	const G4String& processName,
                                          	G4ProcessType type,
						const G4double pMeanFreePathFactor)
  : G4VDiscreteProcess(processName, type)
  , theGamma(G4Gamma::Gamma()), fMeanFreePathFactor(pMeanFreePathFactor)
{
...
/////////////////////////////////////////////////////////////////////////
// Destructor
SynchrotronRadiation::~SynchrotronRadiation()
{
  delete genAngle;
...
void SynchrotronRadiation::SetAngularGenerator(G4VEmAngularDistribution* p)
{
  if(p != genAngle)
  {
    delete genAngle;
...
G4bool SynchrotronRadiation::IsApplicable(
...
G4double SynchrotronRadiation::GetMeanFreePath(const G4Track& trackData,
                                                 G4double,
...
///////////////////////////////////////////////////////////////////////////////
G4VParticleChange* SynchrotronRadiation::PostStepDoIt(
...
///////////////////////////////////////////////////////////////////////////////
G4double SynchrotronRadiation::InvSynFracInt(G4double x)
// direct generation
{
  // from 0 to 0.7
...
G4double SynchrotronRadiation::GetRandomEnergySR(G4double gamma,
                                                   G4double perpB,
                                                   G4double mass_c2)
{
  ...
  if(verboseLevel > 0 && FirstTime1)
  {
    ...
    G4cout << "SynchrotronRadiation::GetRandomEnergySR :" << '\n'
...
///////////////////////////////////////////////////////////////////////////////
void SynchrotronRadiation::BuildPhysicsTable(const G4ParticleDefinition& part)
{
...
///////////////////////////////////////////////////////////////////////////////
void SynchrotronRadiation::ProcessDescription(std::ostream& out) const
{
  out << GetProcessName()
